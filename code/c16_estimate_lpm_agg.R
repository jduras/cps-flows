...
# save(df_lpm_results_agg, file = str_c(edir_cps, "out_lpm_results_agg.Rdata"))
...
save(df_lpm_results_agg_coefs, file = str_c(edir_cps, "out_lpm_results_agg_coefs.Rdata"))
